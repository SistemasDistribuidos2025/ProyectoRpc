...
public class PrimerUsuarioLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        if (!presidenteExiste) {
            ...
            presidente.setPassword("Presidente123"); // password directo

            usuarioServicio.guardarPrimerUsuario(presidente, "Presidente123");
            System.out.println("Usuarios después: " + usuarioServicio.listarTodos().size() + ", id: " + presidente.getId());
            System.out.println("Usuario PRESIDENTE creado");
        }
    }
}