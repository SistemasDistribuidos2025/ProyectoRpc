 ...
 *   !proto.donaciones.ListaEventosResponse>}
 */
const methodDescriptor_EventosService_ListarEventosPropios = new grpc.web.MethodDescriptor(
  '/donaciones.EventosService/ListarEventosPropios',
  grpc.web.MethodType.UNARY,
  proto.donaciones.Vacio,
  proto.donaciones.ListaEventosResponse,
  /**
 ...
 *     The XHR Node Readable Stream
 */
proto.donaciones.EventosServiceClient.prototype.listarEventosPropios =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/donaciones.EventosService/ListarEventosPropios',
      request,
      metadata || {},
      methodDescriptor_EventosService_ListarEventosPropios,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.donaciones.EventosServicePromiseClient.prototype.listarEventosPropios =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/donaciones.EventosService/ListarEventosPropios',
      request,
