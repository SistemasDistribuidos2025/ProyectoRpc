...
public class SolicitudesExtProducer {
    ...
    private final List<String> categorias = List.of("ALIMENTOS", "ROPA", "UTILES");
    private final List<String> descripciones = List.of("Arroz", "Camperas", "Cuadernos");

    @Scheduled(fixedRate = 60000) // cada 60 segundos genera una nueva solicitud externa

    public void generarSolicitud() {
        String idOrg = "ORG-" + (random.nextInt(3) + 1);
        ...
        System.out.println("[Simulador] Enviada solicitud automatica: " + dto);
    }
